...
<main>
<div class="breadcrumb"><a href="../index.html">Home</a> &rsaquo; <a href="../18-admin-guide/README.html">Admin Guide</a> &rsaquo; Admin Guide</div>
<h1>Admin Guide</h1>
<h1 id="admin-guide">Admin Guide</h1>
<p>Guidance for administrators on managing and maintaining a Gitea instance,
covering the web-based <code>/-/admin</code> panel, the <code>dump</code>/<code>doctor</code> CLI
maintenance commands, and the metrics/profiling surfaces used to observe
a running instance.</p>
...
<tbody>
<tr>
<td><a href="admin-panel-and-operations.html">Admin Panel &amp; Operations</a></td>
<td>The <code>/-/admin</code> web UI (<code>routers/web/admin</code>): dashboard, self-check, user/org/repo/package administration, auth sources, system webhooks, notices, and the monitor sub-panel (cron, queues, stacktraces, diagnosis ZIP)</td>
</tr>
<tr>
<td><a href="backup-restore-and-doctor.html">Backup, Restore &amp; Doctor</a></td>
<td><code>gitea dump</code>/restore procedures and the <code>gitea doctor check</code>/<code>recreate-table</code>/<code>convert</code> diagnostic and repair subcommands, including the full check catalog</td>
</tr>
<tr>
<td><a href="monitoring-and-observability.html">Monitoring &amp; Observability</a></td>
<td>The <code>/metrics</code> Prometheus endpoint, <code>pprof</code> profiling paths, and the Grafana monitoring mixin, plus how they relate to the CLI and <code>/-/admin</code> UI</td>
</tr>
<tr>
<td><a href="../16-cli-admin/cli-commands.html">CLI &amp; Admin Operations</a></td>
<td>Full subcommand reference for administering a Gitea instance</td>
</tr>
<tr>
<td><a href="../04-configuration/settings-catalog.html">Settings Catalog</a></td>
<td><code>app.ini</code> reference for tuning a running instance</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td>Install/run Gitea for the first time</td>
<td><a href="../03-getting-started/README.html">Getting Started</a></td>
</tr>
<tr>
<td>Understand deployment options (single-node vs HA)</td>
<td><a href="../02-architecture/deployment-topologies.html">Deployment Topologies</a></td>
</tr>
<tr>
<td>Manage package registry storage/cleanup</td>
...
<div class="page-nav">
<span></span>
<a href="admin-panel-and-operations.html" class="nav-next"><div class="nav-label">Next →</div><div class="nav-title">Admin Panel & Operations</div></a>
</div>
