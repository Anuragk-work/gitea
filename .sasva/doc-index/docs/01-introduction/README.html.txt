...
<main>
<div class="breadcrumb"><a href="../index.html">Home</a> &rsaquo; <a href="../01-introduction/README.html">Introduction</a> &rsaquo; Introduction</div>
<h1>Introduction</h1>
<h1 id="introduction">Introduction</h1>
<p>An overview of what Gitea is, its history, feature domains, licensing, and project governance.</p>
<h2 id="what-gitea-is">What Gitea Is<a href="#what-gitea-is" class="heading-anchor" aria-label="Link">#</a></h2>
<p>Gitea is a self-hosted, lightweight software forge that provides Git hosting, a REST/Swagger
API, an issue tracker, pull requests with code review, project boards (kanban), a wiki,
organizations/teams, a multi-ecosystem package registry, and a CI/CD system (<strong>Gitea Actions</strong>,
which reuses GitHub Actions workflow syntax) — all shipped as a single static Go binary
(module <code>gitea.dev</code>, built with <strong>Go 1.26.4</strong> per <code>go.mod</code>). Because it is written in Go, it runs
on <strong>all</strong> platforms and architectures that Go supports, including Linux, macOS,
FreeBSD/OpenBSD, and Windows, on x86, amd64, ARM, RISC-V 64, and PowerPC.</p>
<p>Gitea began in 2016 as a fork of <a href="https://gogs.io">Gogs</a> — the copyright header in
<a href="../../LICENSE"><code>LICENSE</code></a> still credits both "The Gitea Authors" (2016) and "The Gogs Authors"
...
<a href="../community-governance.html">Community Governance</a> and summarized in
<a href="../22-contributing-development/contribution-workflow.html">Contribution Workflow</a>; the current
list of maintainers is tracked in the root <a href="../../MAINTAINERS"><code>MAINTAINERS</code></a> file and on the
<a href="https://github.com/orgs/go-gitea/people">GitHub organization people page</a>.</p>
<p>The backend follows a <code>cmd → routers → services → models → modules</code> layering (see
<a href="../02-architecture/README.html">Architecture</a>), and the web frontend is a hybrid of
server-rendered Go <code>html/template</code> views progressively enhanced with TypeScript, Vue 3, and
Vite-bundled assets under <code>web_src/</code>, styled with Tailwind CSS and Fomantic UI.</p>
<p>Gitea can run against SQLite, MySQL, PostgreSQL, or MSSQL, can be deployed as a single binary,
inside Docker/Podman (official image at
<a href="https://hub.docker.com/r/gitea/gitea">hub.docker.com/r/gitea/gitea</a>), via Gitea Cloud
(free trial at <a href="https://cloud.gitea.com">cloud.gitea.com</a>), or explored via the public demo at
<a href="https://demo.gitea.com">demo.gitea.com</a> and the free hosted service at
<a href="https://gitea.com/user/login">gitea.com</a>.</p>
<h2 id="feature-domains">Feature Domains<a href="#feature-domains" class="heading-anchor" aria-label="Link">#</a></h2>
<p>Gitea's feature set spans Git hosting/collaboration, project management, automation, and
extensibility. The map below groups the domains covered by this documentation set and links each
to the section where it is documented in depth.</p>
...
<tbody>
<tr>
<td>Git hosting, backends, and repository access</td>
<td><a href="../10-git-integration/README.html">Git Integration</a></td>
</tr>
<tr>
<td>Repository management (branches, releases, wiki)</td>
<td><a href="../12-repository-management/README.html">Repository Management</a></td>
</tr>
<tr>
<td>Issues, pull requests, and code review</td>
<td><a href="../13-issues-pullrequests/README.html">Issues &amp; Pull Requests</a></td>
</tr>
<tr>
<td>Actions / CI-CD</td>
<td><a href="../14-actions-ci/README.html">Actions &amp; CI</a></td>
</tr>
<tr>
<td>Package registry</td>
<td><a href="../15-packages-registry/README.html">Packages &amp; Registry</a></td>
</tr>
<tr>
<td>Webhooks &amp; third-party integrations</td>
<td><a href="../16-webhooks-integrations/README.html">Webhooks &amp; Integrations</a></td>
</tr>
<tr>
<td>Notifications (web &amp; email)</td>
<td><a href="../17-notifications/README.html">Notifications</a></td>
</tr>
<tr>
<td>Administration, backup/restore, doctor</td>
<td><a href="../18-admin-guide/README.html">Admin Guide</a></td>
</tr>
<tr>
<td>Authentication (OAuth2, LDAP, 2FA, WebAuthn)</td>
<td><a href="../11-authentication/README.html">Authentication</a></td>
</tr>
<tr>
<td>REST/Swagger API</td>
<td><a href="../07-rest-api/README.html">REST API</a></td>
</tr>
</tbody>
</table>
<h2 id="licensing-and-security">Licensing and Security<a href="#licensing-and-security" class="heading-anchor" aria-label="Link">#</a></h2>
<p>Gitea is licensed under the <strong>MIT License</strong> — see the root <a href="../../LICENSE"><code>LICENSE</code></a> file for
...
commercially) under those terms.</p>
<p>Vulnerability reporting follows the process in the root <a href="../../SECURITY.html"><code>SECURITY.md</code></a>:
security issues should be reported privately to <code>security@gitea.io</code> (optionally encrypted with
the published PGP key) rather than filed as public issues, and previously-disclosed
vulnerabilities are listed at <a href="https://about.gitea.com/security">about.gitea.com/security</a>. For
...
<a href="../../derived-docs/01-overview/security-posture-overview.html">Security Posture Overview</a> in the
security-focused documentation set. This Introduction section does not duplicate that analysis;
it links to it as the canonical source.</p>
<h2 id="section-contents">Section Contents<a href="#section-contents" class="heading-anchor" aria-label="Link">#</a></h2>
<table>
<thead>
<tr>
<th>Page</th>
...
<tbody>
<tr>
<td><a href="README.html">Introduction</a></td>
<td>This page — what Gitea is, its feature domains, licensing, and goals</td>
</tr>
</tbody>
</table>
<h2 id="where-to-go-next">Where to Go Next<a href="#where-to-go-next" class="heading-anchor" aria-label="Link">#</a></h2>
<table>
<thead>
<tr>
...
<tbody>
<tr>
<td>Install and run Gitea</td>
<td><a href="../03-getting-started/README.html">Getting Started</a></td>
</tr>
<tr>
<td>Understand the system design</td>
<td><a href="../02-architecture/README.html">Architecture</a></td>
</tr>
<tr>
<td>Understand governance and the maintainer/review process</td>
<td><a href="../community-governance.html">Community Governance</a></td>
</tr>
<tr>
<td>Review the security posture and disclosure process</td>
<td><a href="../../derived-docs/01-overview/security-posture-overview.html">Security Posture Overview</a></td>
</tr>
<tr>
<td>See the full section index</td>
...
<a href="#what-gitea-is" class="" data-anchor="what-gitea-is">What Gitea Is</a>
<a href="#feature-domains" class="" data-anchor="feature-domains">Feature Domains</a>
<a href="#licensing-and-security" class="" data-anchor="licensing-and-security">Licensing and Security</a>
<a href="#section-contents" class="" data-anchor="section-contents">Section Contents</a>
<a href="#where-to-go-next" class="" data-anchor="where-to-go-next">Where to Go Next</a>
</aside>
