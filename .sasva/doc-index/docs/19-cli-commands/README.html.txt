=== FILE: docs/19-cli-commands/README.html ===
=== METADATA: format=html ===
[SUMMARY] <!DOCTYPE html> <html lang="en" data-theme="dark"> <head> <meta charset="UTF-8"> <meta name="viewport" content="width=device-width, initial-scale=1.0"> <title>CLI Commands</title> <script src="https://cdn.jsdelivr.net/npm/mermaid@11/dist/mermaid.min.js"></script> <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11/build/styles/github-dark.min.css"> <script src="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11/build/highlight.min.
...
<main>
<div class="breadcrumb"><a href="../index.html">Home</a> &rsaquo; <a href="../19-cli-commands/README.html">Cli Commands</a> &rsaquo; CLI Commands</div>
<h1>CLI Commands</h1>
<h1 id="cli-commands">CLI Commands</h1>
<p>Reference documentation for Gitea's command-line interface and subcommands.</p>
<p>This is a pointer section: the full CLI subcommand reference lives under
<strong>16 · CLI &amp; Admin</strong> to avoid duplicating the same content in two places.</p>
...
<td>Full subcommand reference: <code>web</code>, <code>admin</code>, <code>dump</code>, <code>migrate</code>, <code>doctor</code>, <code>hook</code>, <code>serv</code>, <code>actions</code>, and more</td>
</tr>
<tr>
<td><a href="cli-command-reference-index.html">CLI Command Reference Index (pointer)</a></td>
<td>Short pointer page for this section — see the full <a href="../16-cli-admin/cli-command-reference-index.html">CLI Command Reference Index</a> in section 16 for the complete alphabetical table</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td>See admin/operational guidance that uses these commands</td>
<td><a href="../18-admin-guide/README.html">Admin Guide</a></td>
</tr>
<tr>
<td>See the settings these commands read/write</td>
