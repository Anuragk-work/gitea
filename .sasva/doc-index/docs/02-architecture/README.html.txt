=== FILE: docs/02-architecture/README.html ===
=== METADATA: format=html ===
[SUMMARY] <!DOCTYPE html> <html lang="en" data-theme="dark"> <head> <meta charset="UTF-8"> <meta name="viewport" content="width=device-width, initial-scale=1.0"> <title>Architecture</title> <script src="https://cdn.jsdelivr.net/npm/mermaid@11/dist/mermaid.min.js"></script> <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11/build/styles/github-dark.min.css"> <script src="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11/build/highlight.min.
...
<main>
<div class="breadcrumb"><a href="../index.html">Home</a> &rsaquo; <a href="../02-architecture/README.html">Architecture</a> &rsaquo; Architecture</div>
<h1>Architecture</h1>
<h1 id="architecture">Architecture</h1>
<p>A high-level look at Gitea's system architecture, components, and how they interact.</p>
<p>Gitea runs as a single Go binary that hosts an HTTP router (web UI + REST API),
...
used to deploy Gitea in production.</p>
...
<tbody>
<tr>
<td><a href="system-architecture.html">System Architecture</a></td>
<td>Component diagram, layering (routers → services → models/modules), and how the pieces fit together</td>
</tr>
<tr>
<td><a href="request-lifecycle.html">Request Lifecycle</a></td>
<td>Step-by-step trace of an HTTP request from Chi routing through middleware, context setup, and handler dispatch</td>
</tr>
<tr>
<td><a href="module-dependency-map.html">Module Dependency Map</a></td>
<td>The <code>modules/</code> → <code>models/</code> → <code>services/</code> → <code>routers/</code> layering rule, naming conventions, and how to verify it with grep</td>
</tr>
<tr>
<td><a href="deployment-topologies.html">Deployment Topologies</a></td>
<td>Single-node, HA/clustered, and containerized deployment patterns, including storage and database considerations</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td>See the database schema</td>
<td><a href="../05-database-models/README.html">Database &amp; Models</a></td>
</tr>
<tr>
<td>See how HTTP routes are wired up</td>
<td><a href="../06-web-routers/README.html">Web Routers</a></td>
</tr>
<tr>
<td>See the shared internal modules referenced by the dependency map</td>
...
<div class="page-nav">
<span></span>
<a href="deployment-topologies.html" class="nav-next"><div class="nav-label">Next →</div><div class="nav-title">Deployment Topologies</div></a>
</div>
