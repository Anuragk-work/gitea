...
<title>CLI & Admin Operations</title>
...
<main>
<div class="breadcrumb"><a href="../index.html">Home</a> &rsaquo; <a href="../16-cli-admin/README.html">Cli Admin</a> &rsaquo; CLI & Admin Operations</div>
<h1>CLI & Admin Operations</h1>
<h1 id="cli-admin-operations">CLI &amp; Admin Operations</h1>
<p>Reference documentation for Gitea's command-line administration tooling.</p>
<p>Gitea ships as a single static binary that acts both as the web application
and as the command-line administration tool, built on <code>urfave/cli</code> in
<code>cmd/</code>. Every operational task — starting the web server, running database
migrations, managing users, backing up data, regenerating SSH keys, or
invoking internal Git hooks — is implemented as a CLI subcommand.</p>
...
<tbody>
<tr>
<td><a href="cli-commands.html">CLI &amp; Admin Operations</a></td>
<td>Full subcommand reference: <code>web</code>, <code>admin</code>, <code>dump</code>, <code>migrate</code>, <code>doctor</code>, <code>hook</code>, <code>serv</code>, <code>actions</code>, and more, with flags and usage examples</td>
</tr>
<tr>
<td><a href="cli-command-reference-index.html">CLI Command Reference Index</a></td>
<td>Condensed, alphabetically sorted lookup table of every <code>gitea</code> CLI subcommand, its source file, and its constructor function — cross-checked against <code>cmd/*.go</code></td>
</tr>
<tr>
<td><a href="service-management.html">Running Gitea as a System Service</a></td>
<td>systemd, SysV init, OpenRC, OpenWrt, FreeBSD/OpenBSD <code>rc.d</code>, Solaris SMF, macOS <code>launchd</code>, and Supervisor service definitions (<code>contrib/service/*</code>), and how each maps onto Gitea's own graceful restart/shutdown model</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td>See the <code>app.ini</code> settings the CLI reads</td>
<td><a href="../04-configuration/settings-catalog.html">Settings Catalog</a></td>
</tr>
<tr>
<td>See day-to-day administration guidance</td>
<td><a href="../18-admin-guide/README.html">Admin Guide</a></td>
</tr>
<tr>
<td>See how internal Git hooks integrate with the <code>hook</code> subcommand</td>
...
<div class="page-nav">
<span></span>
<a href="cli-command-reference-index.html" class="nav-next"><div class="nav-label">Next →</div><div class="nav-title">CLI Command Reference Index</div></a>
</div>
