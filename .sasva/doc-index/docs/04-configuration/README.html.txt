=== FILE: docs/04-configuration/README.html ===
=== METADATA: format=html ===
[SUMMARY] <!DOCTYPE html> <html lang="en" data-theme="dark"> <head> <meta charset="UTF-8"> <meta name="viewport" content="width=device-width, initial-scale=1.0"> <title>Configuration</title> <script src="https://cdn.jsdelivr.net/npm/mermaid@11/dist/mermaid.min.js"></script> <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11/build/styles/github-dark.min.css"> <script src="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11/build/highlight.min.
...
<main>
<div class="breadcrumb"><a href="../index.html">Home</a> &rsaquo; <a href="../04-configuration/README.html">Configuration</a> &rsaquo; Configuration</div>
<h1>Configuration</h1>
<h1 id="configuration">Configuration</h1>
<p>Details on configuring Gitea via <code>app.ini</code> settings and environment variables.</p>
<p>Gitea is configured through a single INI-format file (<code>app.ini</code>), loaded and
parsed by <code>modules/setting</code>. Nearly every subsystem — database, mailer,
storage, cache, queue, sessions, package registry, Actions — has its own INI
section with typed Go struct bindings. See
<a href="../03-getting-started/configuration-app-ini.html">Configuration (<code>app.ini</code>)</a> in
Getting Started for the file format and how it is loaded, and the
<a href="settings-catalog.html">Settings Catalog</a> in this section for the exhaustive
reference of sections and keys.</p>
...
<tbody>
<tr>
<td><a href="settings-catalog.html">Settings Catalog</a></td>
<td>Reference table of <code>app.ini</code> sections/keys, their Go binding structs in <code>modules/setting</code>, defaults, and purpose</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td>See the INI file format and how it's loaded</td>
<td><a href="../03-getting-started/configuration-app-ini.html">Configuration (<code>app.ini</code>)</a></td>
</tr>
<tr>
<td>Configure storage, cache, or queue backends</td>
<td><a href="../09-core-modules/storage-queue-cache.html">Storage, Queue &amp; Caching</a></td>
</tr>
<tr>
<td>Configure authentication providers</td>
...
<div class="page-nav">
<span></span>
<a href="settings-catalog.html" class="nav-next"><div class="nav-label">Next →</div><div class="nav-title">Settings Catalog</div></a>
</div>
