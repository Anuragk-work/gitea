=== FILE: docs/09-core-modules/README.md ===
=== METADATA: format=md ===
[SUMMARY] # Core Modules Documentation of Gitea's shared internal modules used across the codebase. ## Pages - [Modules Catalog (Full)](modules-catalog-full.md) — table + diagram of all 85 `modules/*` packages grouped by responsibility - [Git Module](git-module.md) — the dual gogit/nogogit backend, catfile-batch protocol, diff/grep, version-gated features (see also [10 · Git Integration](../10-git-integration/README.
