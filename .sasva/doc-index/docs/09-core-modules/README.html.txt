=== FILE: docs/09-core-modules/README.html ===
=== METADATA: format=html ===
[SUMMARY] <!DOCTYPE html> <html lang="en" data-theme="dark"> <head> <meta charset="UTF-8"> <meta name="viewport" content="width=device-width, initial-scale=1.0"> <title>Core Modules</title> <script src="https://cdn.jsdelivr.net/npm/mermaid@11/dist/mermaid.min.js"></script> <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11/build/styles/github-dark.min.css"> <script src="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11/build/highlight.min.
...
<main>
<div class="breadcrumb"><a href="../index.html">Home</a> &rsaquo; <a href="../09-core-modules/README.html">Core Modules</a> &rsaquo; Core Modules</div>
<h1>Core Modules</h1>
<h1 id="core-modules">Core Modules</h1>
<p>Documentation of Gitea's shared internal modules used across the codebase.</p>
<h2 id="pages">Pages<a href="#pages" class="heading-anchor" aria-label="Link">#</a></h2>
<ul>
<li><a href="modules-catalog-full.html">Modules Catalog (Full)</a> — table + diagram of all 85 <code>modules/*</code> packages grouped by responsibility</li>
<li><a href="git-module.html">Git Module</a> — the dual gogit/nogogit backend, catfile-batch protocol, diff/grep, version-gated features (see also <a href="../10-git-integration/README.html">10 · Git Integration</a> for the <code>gitrepo</code> layer and the end-to-end push/hook sequence diagram)</li>
<li><a href="indexers.html">Search &amp; Indexing</a> — code, issue/PR, and repo-language-statistics indexers (Bleve, Elasticsearch, Meilisearch, DB, git-grep fallback)</li>
<li><a href="lfs-and-hooks.html">Git LFS &amp; Server-Side Hooks</a> — LFS pointer files/content store, HTTP Batch API, SSH <code>git-lfs-transfer</code>, pre/post-receive hooks</li>
<li><a href="markup-engines.html">Markup Rendering Engines</a> — pluggable markup renderers, sanitization, syntax highlighting, emoji, and charset detection</li>
<li><a href="storage-queue-cache.html">Storage, Queue &amp; Caching</a> — object storage backends, async job queues, caching, and distributed locks</li>
<li><a href="notify-mailer-webhook.html">Notifications, Mailer &amp; Webhooks</a> — the <code>notify.Notifier</code> fan-out pattern, outgoing webhooks, mailer, and SSE</li>
<li><a href="frontend-build.html">Frontend Build Pipeline</a> — Vite/esbuild/pnpm build tooling for <code>web_src/</code></li>
<li><a href="frontend-features.html">Frontend Features</a> — notable client-side feature implementations</li>
</ul>
<div class="page-nav">
<span></span>
<a href="frontend-build.html" class="nav-next"><div class="nav-label">Next →</div><div class="nav-title">Frontend Build Pipeline</div></a>
</div>
