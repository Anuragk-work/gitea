=== FILE: docs/build-cicd-deployment/README.html ===
=== METADATA: format=html ===
[SUMMARY] <!DOCTYPE html> <html lang="en" data-theme="dark"> <head> <meta charset="UTF-8"> <meta name="viewport" content="width=device-width, initial-scale=1.0"> <title>Build, CI/CD & Deployment</title> <script src="https://cdn.jsdelivr.net/npm/mermaid@11/dist/mermaid.min.js"></script> <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11/build/styles/github-dark.min.css"> <script src="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11/build/highlight.min.
...
<title>Build, CI/CD & Deployment</title>
...
<main>
<div class="breadcrumb"><a href="../index.html">Home</a> &rsaquo; <a href="../build-cicd-deployment/README.html">Build Cicd Deployment</a> &rsaquo; Build, CI/CD & Deployment</div>
<h1>Build, CI/CD & Deployment</h1>
<h1 id="build-cicd-deployment">Build, CI/CD &amp; Deployment</h1>
<p>This section documents how the Gitea <em>project itself</em> is built, tested by
continuous integration, packaged, and containerized — as distinct from
section <a href="../22-contributing-development/README.html">22 · Contributing &amp; Development</a>,
which covers the human contribution workflow, and
<a href="../03-getting-started/README.html">03 · Getting Started</a>, which covers building
Gitea as an end user.</p>
...
<tbody>
<tr>
<td><a href="makefile-and-build.html">Makefile &amp; Build System</a></td>
<td>The root <code>Makefile</code> targets, build tags, cross-compilation, and asset generation (<code>make generate</code>, <code>make build</code>)</td>
</tr>
<tr>
<td><a href="docker-and-packaging.html">Docker &amp; Packaging</a></td>
<td>The official <code>Dockerfile</code>(s), multi-stage builds, <code>docker-compose</code> examples, and OS packages</td>
</tr>
<tr>
<td><a href="github-workflows.html">GitHub Workflows &amp; Actions</a></td>
<td>The <code>.github/workflows/*.yml</code> pipelines that lint, test, build, and release Gitea on every push/PR</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td>Build Gitea from source as an end user</td>
<td><a href="../03-getting-started/installation-and-build.html">Installation and Build</a></td>
</tr>
<tr>
<td>Understand the release process/versioning</td>
<td><a href="../22-contributing-development/contribution-workflow.html">Contribution Workflow &amp; Governance</a></td>
</tr>
<tr>
<td>Run Gitea's own test suites</td>
<td><a href="../21-testing-quality/unit-integration-e2e-fuzz.html">Unit, Integration, E2E &amp; Fuzz Testing</a></td>
</tr>
</tbody>
</table>
<div class="page-nav">
<span></span>
<a href="docker-and-packaging.html" class="nav-next"><div class="nav-label">Next →</div><div class="nav-title">Docker & Packaging</div></a>
</div>
