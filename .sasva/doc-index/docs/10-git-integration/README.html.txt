=== FILE: docs/10-git-integration/README.html ===
=== METADATA: format=html ===
[SUMMARY] <!DOCTYPE html> <html lang="en" data-theme="dark"> <head> <meta charset="UTF-8"> <meta name="viewport" content="width=device-width, initial-scale=1.0"> <title>Git Integration</title> <script src="https://cdn.jsdelivr.net/npm/mermaid@11/dist/mermaid.min.js"></script> <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11/build/styles/github-dark.min.css"> <script src="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11/build/highlight.min.
...
<main>
<div class="breadcrumb"><a href="../index.html">Home</a> &rsaquo; <a href="../10-git-integration/README.html">Git Integration</a> &rsaquo; Git Integration</div>
<h1>Git Integration</h1>
<h1 id="git-integration">Git Integration</h1>
<p>How Gitea interacts with the underlying Git binary, on-disk repository
storage, and the SSH/HTTP transports that carry <code>git push</code>/<code>git fetch</code>
traffic to and from it.</p>
<p>Gitea does not reimplement Git — it shells out to (and parses the output of)
the system <code>git</code> binary through the <code>modules/git</code> package (or, optionally, a
pure-Go <code>go-git</code>-backed implementation selected at compile time), resolves
repository paths and caches open handles through <code>modules/gitrepo</code>, and
...
documented under <strong>09 · Core Modules</strong> (since it is a dependency-free shared
...
perspective and adds the <code>gitrepo</code> abstraction and hook-lifecycle detail that
core-modules coverage summarizes only briefly.</p>
...
<tbody>
<tr>
<td><a href="git-backends-and-catfile.html">Git Backends &amp; Cat-File Batch Processes</a></td>
<td>Summary of the <code>gogit</code>/<code>nogogit</code> build-tag backends and the long-lived <code>git cat-file --batch</code>/<code>--batch-command</code> subprocess protocol, with pointers to the full reference</td>
</tr>
<tr>
<td><a href="gitrepo-and-repository-access.html">GitRepo &amp; Repository Access</a></td>
<td>The <code>modules/gitrepo</code> abstraction: resolving a database <code>Repository</code> to an on-disk path, request-scoped handle caching, write-lock serialization, and the path-aware wrappers services call instead of touching <code>modules/git</code> directly</td>
</tr>
<tr>
<td><a href="git-operations-and-hooks.html">Git Operations &amp; Server-Side Hooks</a></td>
<td>The hook delegation/installation pattern, and a full sequence diagram tracing a <code>git push</code> over SSH through <code>modules/ssh</code> → <code>cmd/serv.go</code> → the internal private API → <code>git-receive-pack</code> → <code>pre-receive</code>/<code>post-receive</code></td>
</tr>
<tr>
<td><a href="../09-core-modules/git-module.html">Git Module</a></td>
<td>The <code>modules/git</code> wrapper: repository objects, commits, branches, diffs, and command execution (canonical deep reference)</td>
</tr>
<tr>
<td><a href="../09-core-modules/lfs-and-hooks.html">Git LFS &amp; Server-Side Hooks</a></td>
<td>Git LFS object storage/transfer and the <code>pre-receive</code>/<code>post-receive</code>/<code>update</code>/<code>proc-receive</code> hook pipeline (canonical deep reference)</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td>See the repository ORM entity that wraps a Git repo on disk</td>
<td><a href="../05-database-models/repository-model.html">Repository Model</a></td>
</tr>
<tr>
<td>See how a push triggers webhooks and Actions</td>
<td><a href="../16-webhooks-integrations/webhook-delivery-pipeline.html">Webhook Delivery Pipeline</a></td>
</tr>
<tr>
<td>See how <code>gitea doctor</code> detects broken/out-of-date hooks</td>
<td><a href="../18-admin-guide/backup-restore-and-doctor.html">Backup, Restore &amp; Doctor</a></td>
</tr>
<tr>
<td>See all other shared internal modules</td>
<td><a href="../09-core-modules/README.html">Core Modules</a></td>
</tr>
</tbody>
</table>
<div class="page-nav">
<span></span>
<a href="git-backends-and-catfile.html" class="nav-next"><div class="nav-label">Next →</div><div class="nav-title">Git Backends & Cat-File Batch Processes</div></a>
</div>
