=== FILE: docs/08-services/README.html ===
=== METADATA: format=html ===
[SUMMARY] <!DOCTYPE html> <html lang="en" data-theme="dark"> <head> <meta charset="UTF-8"> <meta name="viewport" content="width=device-width, initial-scale=1.0"> <title>Services</title> <script src="https://cdn.jsdelivr.net/npm/mermaid@11/dist/mermaid.min.js"></script> <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11/build/styles/github-dark.min.css"> <script src="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11/build/highlight.min.
...
<main>
<div class="breadcrumb"><a href="../index.html">Home</a> &rsaquo; <a href="../08-services/README.html">Services</a> &rsaquo; Services</div>
<h1>Services</h1>
<h1 id="services">Services</h1>
<p>An overview of the business logic layer implemented in Gitea's services package.</p>
<p><code>services/</code> sits between the HTTP routers and the <code>models</code>/<code>modules</code> layers.
...
<a href="../02-architecture/module-dependency-map.html">Module Dependency Map</a>, services
may depend on models and modules, but never the other way around.</p>
...
<tbody>
<tr>
<td><a href="auth-providers.html">Authentication &amp; Authorization</a></td>
<td>Auth sources (local, LDAP, OAuth2, SMTP, SSPI), session/token handling, and permission resolution</td>
</tr>
<tr>
<td><a href="services-catalog.html">Services Catalog</a></td>
<td>Narrative deep-dive into the business-logic packages under <code>services/</code>, what each owns, and their key entry points</td>
</tr>
<tr>
<td><a href="services-catalog-full.html">Services Catalog (Full)</a></td>
<td>Flat, complete inventory of all 40 <code>services/*</code> subpackages — one row each, grouped into nine functional clusters with a Mermaid overview diagram</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td>See the models services operate on</td>
<td><a href="../05-database-models/README.html">Database &amp; Models</a></td>
</tr>
<tr>
<td>See the modules services call into</td>
<td><a href="../09-core-modules/README.html">Core Modules</a></td>
</tr>
<tr>
<td>See how services are invoked from HTTP handlers</td>
...
<div class="page-nav">
<span></span>
<a href="auth-providers.html" class="nav-next"><div class="nav-label">Next →</div><div class="nav-title">Authentication & Authorization</div></a>
</div>
