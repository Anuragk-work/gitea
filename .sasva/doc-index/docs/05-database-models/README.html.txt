=== FILE: docs/05-database-models/README.html ===
=== METADATA: format=html ===
[SUMMARY] <!DOCTYPE html> <html lang="en" data-theme="dark"> <head> <meta charset="UTF-8"> <meta name="viewport" content="width=device-width, initial-scale=1.0"> <title>Database & Models</title> <script src="https://cdn.jsdelivr.net/npm/mermaid@11/dist/mermaid.min.js"></script> <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11/build/styles/github-dark.min.css"> <script src="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11/build/highlight.min.
...
<main>
<div class="breadcrumb"><a href="../index.html">Home</a> &rsaquo; <a href="../05-database-models/README.html">Database Models</a> &rsaquo; Database & Models</div>
<h1>Database & Models</h1>
<h1 id="database-models">Database &amp; Models</h1>
<p>Documentation of Gitea's database schema, ORM models, and migrations.</p>
<p>Gitea persists all structured data (users, repositories, issues, pull
requests, releases, packages, actions runs, etc.) through the
<a href="https://xorm.io/">xorm</a> ORM in <code>models/</code>, supporting SQLite, MySQL,
...
<code>models/migrations/</code>. This section documents the DB engine abstraction, the
...
and the fixture-based testing infrastructure that exercises all of it.</p>
...
<tbody>
<tr>
<td><a href="db-engine-and-drivers.html">DB Engine and Drivers</a></td>
<td>The <code>db.Engine</code> abstraction, supported drivers (MySQL, PostgreSQL, MSSQL, SQLite via <code>mattn</code>/<code>modernc</code>), connection setup, and transaction helpers</td>
</tr>
<tr>
<td><a href="migrations.html">Database Migrations</a></td>
<td>How the ordered migration list works, writing a new migration, and running migrations via CLI</td>
</tr>
<tr>
<td><a href="repository-model.html">Repository Model</a></td>
<td>The <code>Repository</code> entity and satellite models: forks, mirrors, releases, topics, stars/watches, wiki, repo units</td>
</tr>
<tr>
<td><a href="issues-and-pulls-model.html">Issues &amp; Pull Requests Model</a></td>
<td><code>Issue</code>, <code>PullRequest</code>, comments, labels, milestones, and their relationships</td>
</tr>
<tr>
<td><a href="user-organization-model.html">User &amp; Organization Model</a></td>
<td><code>User</code>, <code>Team</code>, <code>Organization</code> entities and membership</td>
</tr>
<tr>
<td><a href="permissions-model.html">Permissions Model</a></td>
<td>Access levels, unit-based permissions, and how they are resolved for a given user/repo/org</td>
</tr>
<tr>
<td><a href="supplementary-models.html">Supplementary Models</a></td>
<td>Every remaining <code>models/*</code> package: keys, avatars, dbfs, projects, secrets, system settings, webhooks, admin tasks, activities, actions, packages, git metadata</td>
</tr>
<tr>
<td><a href="testing-fixtures.html">Testing &amp; Fixtures</a></td>
<td>The <code>models/fixtures/</code> YAML data set, the fixture loader, and the assertion/consistency helpers used by model-layer tests</td>
</tr>
</tbody>
</table>
<h2 id="core-entity-relationships">Core Entity Relationships<a href="#core-entity-relationships" class="heading-anchor" aria-label="Link">#</a></h2>
<p>The diagram below shows how the primary entities documented in this section relate to one
another. It intentionally omits the many supplementary tables covered in
<a href="supplementary-models.html">Supplementary Models</a> to keep the core relationships readable — see
...
<p>Every arrow above corresponds to a foreign key documented on the respective entity's own page:
<code>Repository.OwnerID</code> → <code>User.ID</code>, <code>Issue.RepoID</code> → <code>Repository.ID</code>, <code>PullRequest.IssueID</code> →
<code>Issue.ID</code> (a <code>PullRequest</code> row extends exactly one <code>Issue</code> row 1:1), <code>Review.IssueID</code> →
<code>Issue.ID</code>, and so on. See <a href="permissions-model.html">Permissions Model</a> for how the <code>Access</code> cache
table and <code>Team</code>/<code>TeamUnit</code> grants are actually resolved into an effective per-request
<code>Permission</code>.</p>
...
<tbody>
<tr>
<td>See how a request reaches a model</td>
<td><a href="../02-architecture/request-lifecycle.html">Request Lifecycle</a></td>
</tr>
<tr>
<td>See the package registry's own tables</td>
<td><a href="../15-packages-registry/database-schema.html">Packages &amp; Registry: Database Schema</a></td>
</tr>
<tr>
<td>See how permissions gate HTTP routes</td>
<td><a href="../06-web-routers/web-routes.html">Web Router &amp; Server-Rendered UI</a></td>
</tr>
<tr>
<td>See the full Actions/CI run-job-step state machine</td>
<td><a href="../14-actions-ci/actions-architecture.html">Actions &amp; CI: Actions Architecture</a></td>
</tr>
<tr>
<td>See the webhook delivery pipeline built on <code>models/webhook</code></td>
<td><a href="../16-webhooks-integrations/webhook-delivery-pipeline.html">Webhooks &amp; Integrations</a></td>
</tr>
<tr>
<td>Write or run a model-layer unit test</td>
<td><a href="testing-fixtures.html">Testing &amp; Fixtures</a></td>
</tr>
</tbody>
</table>
<div class="page-nav">
<span></span>
<a href="db-engine-and-drivers.html" class="nav-next"><div class="nav-label">Next →</div><div class="nav-title">DB Engine and Drivers</div></a>
</div>
...
<a href="#core-entity-relationships" class="" data-anchor="core-entity-relationships">Core Entity Relationships</a>
