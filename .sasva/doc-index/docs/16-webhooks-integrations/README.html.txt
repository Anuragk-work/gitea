=== FILE: docs/16-webhooks-integrations/README.html ===
=== METADATA: format=html ===
[SUMMARY] <!DOCTYPE html> <html lang="en" data-theme="dark"> <head> <meta charset="UTF-8"> <meta name="viewport" content="width=device-width, initial-scale=1.0"> <title>Webhooks & Integrations</title> <script src="https://cdn.jsdelivr.net/npm/mermaid@11/dist/mermaid.min.js"></script> <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11/build/styles/github-dark.min.css"> <script src="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11/build/highlight.min.
...
<title>Webhooks & Integrations</title>
...
<main>
<div class="breadcrumb"><a href="../index.html">Home</a> &rsaquo; <a href="../16-webhooks-integrations/README.html">Webhooks Integrations</a> &rsaquo; Webhooks & Integrations</div>
<h1>Webhooks & Integrations</h1>
<h1 id="webhooks-integrations">Webhooks &amp; Integrations</h1>
<p>Covers Gitea's outgoing webhook system and its integration surfaces with external services and
third-party tools.</p>
<p>Outbound webhooks are Gitea's primary "push" integration mechanism — repository/organization/
...
which is documented together under <strong>09 · Core Modules</strong>; this section documents the webhook
...
<tbody>
<tr>
<td><a href="webhook-delivery-pipeline.html">Webhook Delivery Pipeline</a></td>
<td>Event trigger → payload construction → queuing → HTTP delivery, signing headers, and retry/backoff behavior, with a full sequence diagram</td>
</tr>
<tr>
<td><a href="webhook-event-types-and-payloads.html">Webhook Event Types &amp; Payloads</a></td>
<td>The full <code>HookEventType</code> vocabulary, supported webhook target types (Gitea, Slack, Discord, Dingtalk, Telegram, MSTeams, Feishu, Matrix, WeChat Work, Packagist), and every payload JSON schema</td>
</tr>
<tr>
<td><a href="third-party-integrations.html">Third-Party Integrations</a></td>
<td>OAuth2 application registration (personal/org/instance-wide), external issue tracker &amp; wiki units, repository migration/mirror downloaders, and package registry protocols</td>
</tr>
<tr>
<td><a href="../09-core-modules/notify-mailer-webhook.html">Notifications, Mailer &amp; Webhooks</a></td>
<td>The broader fan-out architecture — how webhooks relate to the mailer, in-app inbox, and Actions triggers</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td>See the in-app/email notification system</td>
<td><a href="../17-notifications/README.html">Notifications</a></td>
</tr>
<tr>
<td>See how queued jobs (including webhook delivery) are processed</td>
<td><a href="../09-core-modules/storage-queue-cache.html">Storage, Queue &amp; Caching</a></td>
</tr>
<tr>
<td>See Actions, which can also emit workflow-triggered notifications</td>
<td><a href="../14-actions-ci/README.html">Actions &amp; CI</a></td>
</tr>
<tr>
<td>See the full OAuth2 provider flow (Authorization Code + PKCE, grants, scopes)</td>
<td><a href="../11-authentication/tokens-and-oauth-apps.html">Access Tokens &amp; OAuth2 Applications</a></td>
</tr>
<tr>
<td>See the package registry protocol endpoints in full</td>
...
<div class="page-nav">
<span></span>
<a href="third-party-integrations.html" class="nav-next"><div class="nav-label">Next →</div><div class="nav-title">Third-Party Integrations</div></a>
</div>
