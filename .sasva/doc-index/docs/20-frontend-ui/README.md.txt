=== FILE: docs/20-frontend-ui/README.md ===
=== METADATA: format=md ===
[SUMMARY] # Frontend & UI An overview of Gitea's frontend assets, templates, and JavaScript/Vue components. Gitea's UI is a hybrid of server-rendered Go `html/template` views and progressively-enhanced client-side JavaScript/Vue "islands," bundled with Vite and Webpack-era conventions under `web_src/`. This section covers the template layer; the build pipeline and JS/Vue component patterns are covered in depth under [Core Modules](../09-core-modules/README.md).
