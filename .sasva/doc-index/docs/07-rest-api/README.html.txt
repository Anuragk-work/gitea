=== FILE: docs/07-rest-api/README.html ===
=== METADATA: format=html ===
[SUMMARY] <!DOCTYPE html> <html lang="en" data-theme="dark"> <head> <meta charset="UTF-8"> <meta name="viewport" content="width=device-width, initial-scale=1.0"> <title>REST API</title> <script src="https://cdn.jsdelivr.net/npm/mermaid@11/dist/mermaid.min.js"></script> <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11/build/styles/github-dark.min.css"> <script src="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11/build/highlight.min.
...
<main>
<div class="breadcrumb"><a href="../index.html">Home</a> &rsaquo; <a href="../07-rest-api/README.html">Rest Api</a> &rsaquo; REST API</div>
<h1>REST API</h1>
<h1 id="rest-api">REST API</h1>
<p>Reference documentation for Gitea's public REST API endpoints.</p>
<p>Gitea exposes a comprehensive JSON REST API under <code>/api/v1</code>, implemented in
<code>routers/api/v1</code> and documented with Swagger annotations that generate the
interactive API docs served at <code>/api/swagger</code>. The API mirrors most web UI
...
CI systems, and the <code>tea</code> CLI.</p>
...
<tbody>
<tr>
<td><a href="api-v1-overview.html">REST API v1 Overview</a></td>
<td>Route groups, authentication methods, and how endpoints map to <code>routers/api/v1</code></td>
</tr>
<tr>
<td><a href="api-conventions-and-swagger.html">API Conventions &amp; Swagger</a></td>
<td>Response envelopes, pagination, error format, versioning, and how the Swagger spec is generated</td>
</tr>
<tr>
<td><a href="packages-and-actions-api.html">Packages &amp; Actions API</a></td>
<td>The ecosystem-specific package-registry protocol endpoints (<code>/api/packages/*</code>, <code>/v2</code>) and the Actions runner/artifact machine-to-machine API (<code>/api/actions/*</code>), both mounted outside the versioned <code>/api/v1</code> tree</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td>See the package registry's own protocol endpoints</td>
<td><a href="../15-packages-registry/README.html">Packages &amp; Registry</a></td>
</tr>
<tr>
<td>See the server-rendered web routes instead</td>
<td><a href="../06-web-routers/README.html">Web Routers</a></td>
</tr>
<tr>
<td>See how API requests are authenticated</td>
<td><a href="../08-services/auth-providers.html">Authentication &amp; Authorization</a></td>
</tr>
</tbody>
</table>
<div class="page-nav">
<span></span>
<a href="api-conventions-and-swagger.html" class="nav-next"><div class="nav-label">Next →</div><div class="nav-title">API Conventions & Swagger</div></a>
</div>
