=== FILE: docs/15-packages-registry/README.md ===
=== METADATA: format=md ===
[SUMMARY] # Packages & Registry Documentation of Gitea's built-in package registry supporting multiple ecosystems. Gitea includes a first-class package registry capable of emulating the native protocols of 22 different package ecosystems — from npm and Maven to Docker/OCI containers, Debian/RPM Linux repositories, and Terraform remote state.
