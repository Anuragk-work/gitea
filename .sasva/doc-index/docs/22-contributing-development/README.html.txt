=== FILE: docs/22-contributing-development/README.html ===
=== METADATA: format=html ===
[SUMMARY] <!DOCTYPE html> <html lang="en" data-theme="dark"> <head> <meta charset="UTF-8"> <meta name="viewport" content="width=device-width, initial-scale=1.0"> <title>Contributing & Development</title> <script src="https://cdn.jsdelivr.net/npm/mermaid@11/dist/mermaid.min.js"></script> <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11/build/styles/github-dark.min.css"> <script src="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11/build/highlight.min.
...
<title>Contributing & Development</title>
...
<main>
<div class="breadcrumb"><a href="../index.html">Home</a> &rsaquo; <a href="../22-contributing-development/README.html">Contributing Development</a> &rsaquo; Contributing & Development</div>
<h1>Contributing & Development</h1>
<h1 id="contributing-development">Contributing &amp; Development</h1>
<p>Guidelines and workflows for contributing code and documentation to Gitea.</p>
<p>This section documents the end-to-end contributor experience for the Gitea
...
templates and bot automation that keep the tracker consistent.</p>
<ul>
<li><a href="contribution-workflow.html">Contribution Workflow &amp; Governance</a> — the
  ...
  to the dedicated pages below for full detail.</li>
<li><a href="ai-assisted-contributions.html">AI-Assisted Contributions</a> — the human-facing
  AI contribution policy from <code>CONTRIBUTING.md</code>, cross-referenced against the
  machine-facing agent conventions in the repository's root <code>AGENTS.md</code> /
  <code>CLAUDE.md</code> files.</li>
<li><a href="backend-coding-conventions.html">Backend Coding Conventions</a> — the full
  backend package-layering rule, XORM/transaction guidance, Go module
  hygiene, and API v1 conventions from <code>docs/guidelines-backend.md</code>.</li>
<li><a href="frontend-coding-conventions.html">Frontend Coding Conventions</a> — the full
  Vue/Fomantic-UI/Tailwind framework-usage rules, CSS/TypeScript linter
  configuration, and DOM/data-fetching helpers from <code>docs/guidelines-frontend.md</code>.</li>
<li><a href="governance-and-security.html">Governance &amp; Security</a> — the full review,
  label, merge-queue, and maintainer/TOC governance process from
  <code>docs/community-governance.md</code>, plus the vulnerability-reporting process
  from <code>SECURITY.md</code>.</li>
<li><a href="issue-pr-templates-and-automation.html">Issue &amp; PR Templates and Automation</a> —
  every issue form under <code>.github/ISSUE_TEMPLATE/</code>, the PR template, and the
  label/bot automation (<code>labeler.yml</code>, <code>pull-labeler.yml</code>, <code>giteabot.yml</code>,
  <code>giteabot-backport.yml</code>) that acts on them.</li>
</ul>
<div class="page-nav">
<span></span>
<a href="ai-assisted-contributions.html" class="nav-next"><div class="nav-label">Next →</div><div class="nav-title">AI-Assisted Contributions</div></a>
</div>
