=== FILE: docs/22-contributing-development/README.md ===
=== METADATA: format=md ===
[SUMMARY] # Contributing & Development Guidelines and workflows for contributing code and documentation to Gitea. This section documents the end-to-end contributor experience for the Gitea project: how to fork, branch, and submit a pull request; the backend and frontend coding conventions enforced by CI; AI-assisted contribution policy; the refactoring policy; how releases are versioned and shipped; how the project is governed and how security issues are reported; and the issue/PR
