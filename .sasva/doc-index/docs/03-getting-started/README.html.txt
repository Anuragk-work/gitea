=== FILE: docs/03-getting-started/README.html ===
=== METADATA: format=html ===
[SUMMARY] <!DOCTYPE html> <html lang="en" data-theme="dark"> <head> <meta charset="UTF-8"> <meta name="viewport" content="width=device-width, initial-scale=1.0"> <title>Getting Started</title> <script src="https://cdn.jsdelivr.net/npm/mermaid@11/dist/mermaid.min.js"></script> <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11/build/styles/github-dark.min.css"> <script src="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11/build/highlight.min.
...
<main>
<div class="breadcrumb"><a href="../index.html">Home</a> &rsaquo; <a href="../03-getting-started/README.html">Getting Started</a> &rsaquo; Getting Started</div>
<h1>Getting Started</h1>
<h1 id="getting-started">Getting Started</h1>
<p>Instructions for installing, building, and running Gitea for the first time.</p>
<ul>
<li><a href="overview.html">Overview</a> — what Gitea is, its core features, and supported platforms.</li>
<li><a href="installation-and-build.html">Installation and Build</a> — prerequisites, <code>make build</code>, build tags, and binary output.</li>
<li><a href="configuration-app-ini.html">Configuration (<code>app.ini</code>)</a> — the INI configuration format and key sections.</li>
<li><a href="running-gitea.html">Running Gitea</a> — starting the server, the first-run install wizard, and post-install steps.</li>
</ul>
<div class="page-nav">
<span></span>
<a href="configuration-app-ini.html" class="nav-next"><div class="nav-label">Next →</div><div class="nav-title">Configuration (`app.ini`)</div></a>
</div>
