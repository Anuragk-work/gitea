=== FILE: docs/11-authentication/README.md ===
=== METADATA: format=md ===
[SUMMARY] # Authentication Documentation of Gitea's authentication methods, sessions, authorization model, and account security mechanisms. The deepest services-layer write-up of the `auth.Method` interface, the individual provider implementations, and group-sync internals lives in **08 · Services** ([Authentication & Authorization](../08-services/auth-providers.md)).
